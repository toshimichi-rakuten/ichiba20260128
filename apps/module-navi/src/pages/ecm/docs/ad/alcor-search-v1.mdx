...
} from 'ecm/src/modules/alcor-search/integration'

export const meta = {
  title: 'サーチアルコル (旧)',
  description: 'eventページに検索結果のリンク集を作成',
  url: '/ecm/docs/ad/alcor-search-v1',
...
<Note type='error'>
このモジュールは非推奨となり、2026年に削除される予定です。  
代わりに[サーチアルコル](/ecm/docs/ad/alcor-search)をご利用ください。  
</Note>

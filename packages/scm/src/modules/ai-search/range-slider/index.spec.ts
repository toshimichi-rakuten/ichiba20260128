...
test('AI Search SP Range Slider', async ({ page }, testInfo) => {
  ...
  await page.waitForSelector('[data-scm-search-ai-range-slider-to-slider]')
...
test('AI Search MD Range Slider', async ({ page }, testInfo) => {
...
test('AI Search LG Range Slider', async ({ page }, testInfo) => {

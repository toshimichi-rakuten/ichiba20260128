...
test('AI Search SP Suggestion Success', async ({ page }, testInfo) => {
...
test('AI Search MD Suggestion Success', async ({ page }, testInfo) => {
...
test('AI Search LG Suggestion Success', async ({ page }, testInfo) => {

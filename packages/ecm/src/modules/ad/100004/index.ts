// TODO: Remove all ts-nocheck in ad
// @ts-nocheck
...
const dummyData = {
  ...
  '#IMAGEALT1#': '',
  '#TEXT1L1#': 'キャッチ５６７８９０キャッチ５６７８',
  '#TEXT2L1#': '商品名４５６７８９０商品名４５６７８９０商品名４５６７８９０商品名４５６７８９０',
  '#TEXT3L1#': '999,999,999',
  '#TEXT3L2#': '円',
  '#ICONTXTCLASS1-1#': 'free_shipping',
  '#ICONTXT1-1#': '送料無料',
  '#SHOPURL1#': '#',
  '#SHOP1#': '店舗名４５６７８９０店舗名４５６７８９０店舗名４５６７８９０１２',
}
...
export const SP2columnPC2column = {
  sp: {
    col: 2,
    gap: null,
    gapX: 12,
...
export const SP2columnPC3column = {
  sp: {
    col: 2,
    gap: null,
    gapX: 12,
...
export const SP2columnPC4column = {
  sp: {
    col: 2,
    gap: null,
    gapX: 12,
...
const soloWithDummySP2columnPC2columnHtml = addDummyData(soloSP2columnPC2column, dummyData)
const soloWithDummySP2columnPC3columnHtml = addDummyData(soloSP2columnPC3column, dummyData)
const soloWithDummySP2columnPC4columnHtml = addDummyData(soloSP2columnPC4column, dummyData)
...
export const staticSP2columnPC2columnHtml = addGrid(soloWithDummySP2columnPC2columnHtml, SP2columnPC2column)
export const staticSP2columnPC3columnHtml = addGrid(soloWithDummySP2columnPC3columnHtml, SP2columnPC3column)
export const staticSP2columnPC4columnHtml = addGrid(soloWithDummySP2columnPC4columnHtml, SP2columnPC4column)
